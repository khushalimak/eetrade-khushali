...
import easy from "../assets/variation5/asset 9.png";
import product from '../assets/variation5/asset 10.png'
import service from "../assets/variation5/asset 11.png";
import round1 from "../assets/variation5/asset 12.png";
import round2 from "../assets/variation5/asset 12.png";
import round3 from "../assets/variation5/asset 13.png";
import { Link } from "react-router-dom";
import P5Slider from "./slider/p5slider";
      ...
      <div>
        ...
        <section className="IMAGES-AND-DISCRIPTION ">
          <div className="container mx-auto">
            <div className="grid grid-cols-2 gap-01 pt-[100px] px-5">
              <div>
                <P5Slider/>
              </div>

              <div className="main-div-details ml-10">
                  ...
                  <div className="flex items-center">
                    <div>
                      <Link
                        to="/Cart"
                        href="#"
                        className='relative z-10 font-bold bg-[#3577F0] text-white px-20 py-3 rounded-md 
                                                before:absolute
                                                before:content-[""]
                                                before:bg-[#3577F0]
                                                before:left-0
          ...
          <div className="BOTTOM-DISCRIPTION bg-[#F9F3F0] py-[100px] px-20">
            <div className="container mx-auto">
                ...
                <div className="FORM grid grid-cols-2 gap-20">
                  ...
                  <div className="text-gray-500">
                    ...
                    <div className="mt-12">
                      <a
                        href="#"
                        className=" relative z-10 px-9 py-3  rounded-md font-semibold  text-white bg-[#3577F0] 
                                        before:absolute 
                                        before:content-[''] 
                                        before:w-[200px] 
                                        before:rounded-md 
