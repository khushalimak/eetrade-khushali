...
import P3Slider from "./slider/P3slider";
import rimg1 from "../assets/variation3/asset 8.png";
import rimg2 from "../assets/variation3/asset 9.png";
import rimg3 from "../assets/variation3/asset 10.png";
import rimg4 from "../assets/variation3/asset 11.png";
import rimg5 from "../assets/variation3/asset 11.png";
import rimg6 from "../assets/variation3/asset 12.png";
  ...
  return (
    <>
      <div>
        ...
        <section className="NAVBAR-PART sticky top-0 z-20 ">
          <Navbar />
        </section>

        {/* <section className="BGIMG-PART">
          <Bgimg />
        </section> */}

        <section className="IMAGES-AND-DISCRIPTION">
          <div className="grid grid-cols-2 gap-10 pt-[80px] container mx-auto px-20">
            <div>
              <P3Slider />
            </div>
            ...
            <div className="main-div-details ">
              ...
              <h1 className="font-semibold text-2xl text-[#292930] mb-4">
                $155.00 - $255.00
              </h1>
              ...
              <ul className="text-[#417EF0] text-base pt-4 mb-8">
                <li>
              ...
              In ornare lorem ut est dapibus, ut tincidunt nisi pretium. Integer ante<br/> est, elementum eget magna. Pellentesque sagittis dictum libero, eu<br/> dignissim tellus.
              </p>
              <div>
                  ...
                  <div className="flex items-center">
                    <div className="mx-4">
                      <Link
                        to="/Cart"
                        href="#"
                        className='relative z-10 font-bold bg-[#3577F0] text-white mr-10 px-28 py-3 rounded-md 
                                                before:absolute
                                                before:content-[""]
                                                before:bg-[#3577F0]
                                                before:left-0
                    ...
                    <div className="flex mx-4">
                      <Link
                        to="/Wishlist"
                        href="#"
                        className="relative z-10 px-0 py-2 border-2  mr-3 rounded-md
                                                before:absolute 
                                                before:h-[100%]
                                                before:w-[100%]
                                                before:rounded-md
          ...
          <div className="BOTTOM-DETAILS-PART bg-[#F9F3F0] mt-3 py-[100px] px-28">
            <div className=" container mx-auto">
                    ...
                    <div className="flex">
                      <div className="mr-10">
                        <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                          <img className="h-8" src={rimg1} alt="" />
                        </div>
                      ...
                      <div className="mr-10">
                        <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                          <img className="h-8" src={rimg2} alt="" />
                        </div>
                        <h1 className="font-semibold text-xl text-[#292930]">
                          Quality Service
                        </h1>
                      ...
                      <div>
                        <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                          <img className="h-8" src={rimg3} alt="" />
                        </div>
                        <h1 className="font-semibold text-xl text-[#292930]">
                          Original Product
                        </h1>
              ...
              {activeTab === 2 && (
                <div className="ADDITIONAL-INFORMATION mt-12 px-8 animate-blink">
                  <div className="bg-white rounded-md p-5">
                    <div className="py-3 flex bg-[#F6F7FB] text-[#292930] ">
                    ...
                    <div className="py-3 flex  text-[#292930]">
                      <h1 className="w-[500px]  font-semibold px-8">
                        Folded (W/O Wheels)
                      </h1>
                      <h1 className="text-gray-400  font-semibold ml-24">
                  ...
                  <div className="FORM grid grid-cols-2 gap-20">
                    <div className="pr-14">
                      <div className="mb-7">
                        ...
                        <div className="flex">
                          <div>
                            <img className="w-28" src={rimg4} alt="" />
                          </div>
                          <div className="ml-5">
                      ...
                      <div className="mb-7">
                        <div className="flex">
                          <div>
                            <img className="w-28" src={rimg5} alt="" />
                          </div>
                          <div className="ml-5">
                            <div className="flex justify-between ">
                              <h1 className="font-semibold text-lg text-[#292930] hover:text-[#3577F0] duration-500 mb-2">
                      ...
                      <div>
                        <div className="flex">
                          <div>
                            <img className="w-28" src={rimg6} alt="" />
                          </div>
                          <div className="ml-5">
                            <div className="flex justify-between ">
                              <h1 className="font-semibold text-lg text-[#292930] hover:text-[#3577F0] duration-500 mb-2">
                    ...
                    <div className="text-gray-500 ">
                      ...
                      <div className="mt-12">
                        <a
                          href=""
                          className=" relative z-10 px-10 py-3  rounded-md font-semibold text-white bg-[#3577F0] 
                                        before:absolute 
                                        before:content-[''] 
                                        before:w-[220px] 
                                        before:rounded-md 
