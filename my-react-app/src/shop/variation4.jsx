...
import P4Slider from "./slider/P4slider";
import rimg1 from "../assets/variation4/asset 14.png";
import rimg2 from "../assets/variation4/asset 15.png";
import rimg3 from "../assets/variation4/asset 16.png";
      ...
      <div>
        ...
        <section className="IMAGES-AND-DISCRIPTION bg-[#F9F3F0] ">
          <div className="container mx-auto">
            <div className="grid grid-cols-2 gap-20 py-[80px] px-12">
              <div>
                <P4Slider />
              </div>
              ...
              <div className="main-div-details">
                ...
                <ul className="text-[#417EF0] text-lg pt-4 mb-6">
                  <li>
                ...
                <p className="text-gray-500 mb-10">
                  ...
                  Integer ante est,<br/> hendrerit in rutrum quis, elementum eget
                  magna. Pellentesque sagittis dictum<br/> libero, eu dignissim
                  tellus.
                </p>
                <div>
                    ...
                    <div className="flex items-center">
                      <div className="mx-5">
                        <Link
                          to="/Cart"
                          href="#"
                          className='relative z-10 font-bold bg-[#3577F0] text-white px-24 py-3 rounded-md 
                                                before:absolute
                                                before:content-[""]
                                                before:px-32
                                                before:py-5
