...
import Image from '../assets/standard/asset 2.jpeg'
...
export default function Standard() {
  return (
    ...
    <div className="">
     ...
     <div className="STANDARD-POST-SECTION mx-auto container ">
        ...
        <div className="main-section mx-16 my-16 flex">

          <div className="NAV-ICON h-20 sticky top-24  mr-10 ">
          ...
          <div className="RIGHT-SECTION ml-14 ">
