...
import feed4 from '../assets/Homepage/asset 29.png'
...
const FeedBack = () => {
  ...
  return (
    <>
      <div className="feed-slide mx-auto container">
        <div className="bg-[#F9F3F0] py-28 px-32 mt-8">
          <div className="">
            ...
            <Slider ref={(c) => (slider = c)} {...settings}>
              <div className="">
                <div className="bg-white p-10 text-gray-500 leading-7 rounded-lg relative">
                ...
                <div className="flex items-center mt-10">
                  <img src={feed1} className="ml-2" alt="" />
                  <div className="ml-5">
              ...
              <div className="">
                ...
                <div className="flex items-center mt-10">
                  <img src={feed2} className="ml-2" alt="" />
                  <div className="ml-5">
                    <h1 className="text-gray-500">Head Of Idea</h1>
              ...
              <div>
                ...
                <div className="flex items-center mt-10">
                  <img src={feed3} className="ml-2" alt="" />
                  <div className="ml-5">
                    <h1 className="text-gray-500">Head Of Idea</h1>
                    <h1 className="font-semibold text-lg text-[#292930] tracking-wider">
                      James C. Anderson
              ...
              <div className="">
                ...
                <div className="flex items-center mt-10">
                  <img src={feed4} className="ml-2" alt="" />
                  <div className="ml-5">
                    <h1 className="text-gray-500">Head Of Idea</h1>
                    <h1 className="font-semibold text-lg text-[#292930] tracking-wider">
                      James C. Anderson
