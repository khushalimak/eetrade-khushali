...
import handlerimg from "../assets/wishlist/asset 2.png"
import keyboardimg from "../assets/wishlist/asset 3.png"
import cameraimg from "../assets/wishlist/asset 4.png"

export const CartForm = ({ isOpen, onClose }) => {
  const initialState = {
    firstCounter: 15,
    secondCounter: 5,
    thirdCounter: 100,
  ...
  return (
    <div>
      <div className={`sidebar ${isOpen ? "open" : ""} `}>
        ...
        <div className="p-10 bg-white h-[]">
          <div className="flex justify-between items-center mt-8 border-b-[2px] border-[#F6F7FB] pb-7">
            <h1 className="text-2xl font-bold text-[#27272E]">Cart review</h1>
          </div>
          ...
          <div className="mt-10 flex relative border-b border-[#F6F7FB] pb-7">
            <div>
              ...
              <Link to="/productvariation1">
                <img
                  className="h-24 w-32 object-cover rounded-md  cursor-pointer"
                  src={handlerimg}
                ></img>
              </Link>
            </div>
            <div className="flex justify-between w-full ml-8">
              <div>
                ...
                <div className="my-2">
                  <Link
                    to="/productvariation3"
                    className="text-lg  font-bold text-[#292930] hover:text-[#3577F0] cursor-pointer duration-300 "
                  >
                    Wireless PS Handler
                  </Link>
                </div>
              ...
              <div className="flex items-center ">
                <button
                  className="ring-white flex justify-center items-center h-7 w-7 bg-[#F6F7FB] rounded-full cursor-pointer hover:bg-[#3577F0] hover:text-white text-black duration-300"
                  onClick={() => {
                ...
                <button
                  className="ring-white flex justify-center items-center h-7 w-7 bg-[#F6F7FB] rounded-full cursor-pointer hover:bg-[#3577F0] hover:text-white text-black duration-300 text-base"
          ...
          <div className="mt-10 flex relative border-b border-[#F6F7FB] pb-7">
            ...
            <div className="flex justify-between w-full ml-8">
              ...
              <div className="flex items-center ">
                ...
                >
                  <i classnamename="fa-solid fa-minus text-xs"></i>
                </button>
                ...
                <button
                  className="ring-white flex justify-center items-center h-7 w-7 bg-[#F6F7FB] rounded-full cursor-pointer hover:bg-[#3577F0] hover:text-white text-black duration-300 text-base"
                  onClick={() => dispatch({ type: "inc2", value: 1 })}
                >
                  <i classname="fa-solid fa-plus text-xs"></i>
                </button>
              </div>
          ...
          <div className="mt-10 flex relative border-b-[2px] border-[#F6F7FB] pb-20">
            ...
            <div className="flex justify-between w-full ml-8">
              ...
              <div className="flex items-center ">
                ...
                <button
                  className="ring-white flex justify-center items-center h-7 w-7 bg-[#F6F7FB] rounded-full cursor-pointer hover:bg-[#3577F0] hover:text-white text-black duration-300 text-base"
                  onClick={() => dispatch({ type: "inc3", value: 1 })}
                >
