...
import remoteimg from "../assets/Homepage/asset 32.png"

export const SearchForm = ({ isOpen, onClose }) => {
  return (
    <div>
      <div className={`popup ${isOpen ? "open" : ""}`}>
        <div className="absolute -right-5 top-[30px]" onClick={onClose}>
        ...
        <div className="relative">
          <div className="absolute -left-[900px] top-[30px] p-10 rounded-lg bg-white w-[850px]">
            <div className="border py-3 rounded-md">
              <i className="ri-search-line mx-3 text-lg"></i>
              <input
                className="placeholder:text-black outline-none text-base"
                type="text"
            ...
            <div>
              <div className="flex justify-between items-center outline outline-1 outline-gray-200 rounded-md p-7 group hover:shadow-lg hover:shadow-zinc-100 hover:duration-500 hover:outline-none duration-[0.3s]">
                ...
                <div>
                  ...
                  <Link to="/wishlist" href="#">
                    <i className="ri-heart-line  p-3 rounded-md border text-gray-600 hover:text-white hover:bg-[#3577F0] hover:border-none hover:duration-500"></i>
                  </Link>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center outline outline-1 outline-gray-200 rounded-md p-7 group hover:shadow-lg hover:shadow-zinc-100 hover:duration-500 hover:outline-none duration-[0.3s] mt-8">
                ...
                <div>
                  <Link to="/cart" href="#" className="block mb-6">
                    <i className="ri-shopping-cart-line  p-3 rounded-md border text-gray-600 hover:text-white hover:bg-[#3577F0] hover:border-none hover:duration-500"></i>
                  </Link>
                  <Link to="/wishlist" href="#">
                    <i classNamename="ri-heart-line  p-3 rounded-md border text-gray-600 hover:text-white hover:bg-[#3577F0] hover:border-none hover:duration-500"></i>
                  </Link>
                </div>
              </div>
            </div>
