...
export const AccountForm = ({ isOpen }) => {
  return (
    <div>
      <div className={`details-menu ${isOpen ? "open" : ""}`}>
        <div className="absolute top-[70px] right-[100px] bg-white p-5 rounded-md shadow-md">
          <span className="text-xs">QUICKLINKS</span>
          <ul className="w-52 text-[17px] text-black">
            <li className="border-b py-3  hover:text-[#3577F0] duration-300">
          ...
          <div className="flex justify-between items-center mt-5">
            ...
            <Link
              to="/Signup"
              href=""
              className="text-sm text-black underline underline-offset-4 font-medium hover:text-[#3577F0] duration-300"
            >
              REGISTER HERE.
            </Link>
          </div>
